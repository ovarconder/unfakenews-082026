...
const DEFAULT_SETTINGS: SiteSettings = {
  id: "default",
  name: process.env.NEXT_PUBLIC_SITE_NAME || "Siam Heritage",
  tagline: process.env.NEXT_PUBLIC_SITE_TAGLINE || "Discover Thai heritage, arts, and history.",
  description: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || "Siam Heritage — Discover Thai heritage, arts, and history through curated stories, traditions, and cultural insights.",
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://siamheritage.org",
  logo: process.env.NEXT_PUBLIC_SITE_LOGO || "/images/logo/logo-light.png",
  logoFull: process.env.NEXT_PUBLIC_SITE_LOGO_FULL || "/images/logo/logo-full.png",
  ...
  copyright: process.env.NEXT_PUBLIC_COPYRIGHT || `© ${new Date().getFullYear()} ${process.env.NEXT_PUBLIC_SITE_NAME || "Siam Heritage"}. All rights reserved.`,
  locale: "both",
  timezone: "Asia/Bangkok",
  metaTitle: process.env.NEXT_PUBLIC_SITE_NAME ? `${process.env.NEXT_PUBLIC_SITE_NAME} — ${process.env.NEXT_PUBLIC_SITE_TAGLINE || "Discover Thai heritage, arts, and history."}` : "Siam Heritage — Discover Thai heritage, arts, and history.",
  metaDescription: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || "Siam Heritage — Discover Thai heritage, arts, and history through curated stories, traditions, and cultural insights.",
  ogTitle: process.env.NEXT_PUBLIC_SITE_NAME ? `${process.env.NEXT_PUBLIC_SITE_NAME} — ${process.env.NEXT_PUBLIC_SITE_URL || "siamheritage.org"}` : "Siam Heritage — siamheritage.org",
  ogDescription: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || "Discover Thai heritage, arts, and history through curated stories, traditions, and cultural insights.",
  ogImage: process.env.NEXT_PUBLIC_OG_IMAGE || "https://siamheritage.org/images/og-default.jpg",
  twitterHandle: process.env.NEXT_PUBLIC_TWITTER_HANDLE || "@siamheritage",
  ...
  youtubeUrl: "",
  tiktokUrl: "",
  email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "hello@siamheritage.org",
  phone: "",
  address: "",
  showAuthor: true,
